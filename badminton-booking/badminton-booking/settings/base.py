"""
Django settings for badminton-booking project.
"""
import os
...
ADMINS = (
    ("""mayank  saini""", 'mayanksandee@gmail.com'),
)
...
ROOT_URLCONF = 'badminton-booking.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'badminton-booking.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'gallery')
